...
int main (int argc, char *argv[])
{
  ...
  cmd.AddValue ("window-size", "WindowSize. Default 128K.", windowSize);
  cmd.AddValue ("link-delay", "LinkDelay. Default 1ms.", linkDelay);
  cmd.Parse (argc, argv);
